# TamilDropTaxi — Next.js Production Website
...
git remote add origin https://github.com/YOUR_USERNAME/tamilnadudroptaxi.git
...
```
NEXT_PUBLIC_SITE_KEY          = tamilnadudroptaxi
NEXT_PUBLIC_SITE_URL          = https://tamilnadudroptaxi.com
...
SMTP_PORT                     = 465
SMTP_SECURE                   = true
SMTP_USER                     = hello@tamilnadudroptaxi.com
SMTP_PASS                     = your-password
MAIL_TO                       = hello@tamilnadudroptaxi.com
```

**Step 4 — Add Custom Domain**
1. Vercel Dashboard → Domains → Add `tamilnadudroptaxi.com`
...
1. **Search — Branded**: "TamilDropTaxi", "tamilnadudroptaxi.com"
