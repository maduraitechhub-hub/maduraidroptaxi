...
const SITE_NAME  = 'TamilNadu Drop Taxi';
...
export const PAGE_SEO = {
  ...
  book: {
    title:       'Book a Drop Taxi | TamilNadu Drop Taxi',
  ...
  about: {
    title:       'About Us | TamilNadu Drop Taxi',
    description: 'Learn about TamilNadu Drop Taxi — Tamil Nadu\'s trusted outstation cab provider offering transparent one-way taxi fares since 2018. Experienced drivers, GPS-tracked vehicles.',
    keywords:    ['about TamilNadu Drop Taxi', 'trusted taxi service Tamil Nadu'],
    path:        '/about',
  },
  cities: {
    title:       'Cities We Serve | TamilNadu Drop Taxi',
    description: 'TamilNadu Drop Taxi operates from 38 districts and major cities across Tamil Nadu. Find drop taxi routes from your city.',
    keywords:    ['Tamil Nadu taxi cities', 'drop taxi districts Tamil Nadu'],
    path:        '/cities',
  },
  contact: {
    title:       'Contact Us | TamilNadu Drop Taxi',
    description: 'Contact TamilNadu Drop Taxi for booking assistance, route queries, or partnership enquiries. We are available 24/7 on call and WhatsApp.',
    keywords:    ['contact TamilNadu Drop Taxi', 'taxi booking helpline Tamil Nadu'],
    path:        '/contact',
  },
  partner: {
    title:       'Partner With Us | TamilNadu Drop Taxi',
    description: 'Are you a driver or vehicle owner in Tamil Nadu? Partner with TamilNadu Drop Taxi and grow your earnings with consistent outstation bookings.',
  ...
  maduraiLocalRoundTrip: {
    title:       'Madurai Local Sightseeing & Round Trip Taxi | TamilNadu Drop Taxi',
...
export function buildCitySeo(city) {
  return {
    title:       `${city.name} Drop Taxi | One-Way Outstation Cab | TamilNadu Drop Taxi`,
    ...
    openGraph: {
      title:       `${city.name} Drop Taxi | TamilNadu Drop Taxi`,
