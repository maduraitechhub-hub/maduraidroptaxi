...
export const PAGE_SEO = {
  ...
  book: {
    title:       'Book a Drop Taxi | TamilDropTaxi',
  ...
  about: {
    title:       'About Us | TamilDropTaxi',
    description: 'Learn about TamilDropTaxi — Tamil Nadu\'s trusted outstation cab provider offering transparent one-way taxi fares since 2018. Experienced drivers, GPS-tracked vehicles.',
    keywords:    ['about TamilDropTaxi', 'trusted taxi service Tamil Nadu'],
    path:        '/about',
  },
  cities: {
    title:       'Cities We Serve | TamilDropTaxi',
    description: 'TamilDropTaxi operates from 38 districts and major cities across Tamil Nadu. Find drop taxi routes from your city.',
    keywords:    ['Tamil Nadu taxi cities', 'drop taxi districts Tamil Nadu'],
    path:        '/cities',
  },
  contact: {
    title:       'Contact Us | TamilDropTaxi',
    description: 'Contact TamilDropTaxi for booking assistance, route queries, or partnership enquiries. We are available 24/7 on call and WhatsApp.',
    keywords:    ['contact TamilDropTaxi', 'taxi booking helpline Tamil Nadu'],
    path:        '/contact',
  },
  partner: {
    title:       'Partner With Us | TamilDropTaxi',
    description: 'Are you a driver or vehicle owner in Tamil Nadu? Partner with TamilDropTaxi and grow your earnings with consistent outstation bookings.',
  ...
  maduraiLocalRoundTrip: {
    title:       'Madurai Local Sightseeing & Round Trip Taxi | TamilDropTaxi',
...
export function buildCitySeo(city) {
  return {
    title:       `${city.name} Drop Taxi | One-Way Outstation Cab | TamilDropTaxi`,
    ...
    openGraph: {
      title:       `${city.name} Drop Taxi | TamilDropTaxi`,
