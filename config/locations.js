...
export const CITIES = [
  {
    ...
    longDescription:
      'Madurai, the cultural capital of Tamil Nadu, is home to the iconic Meenakshi Amman Temple. Book a reliable drop taxi from Madurai to anywhere across Tamil Nadu with TamilDropTaxi.',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes, TamilDropTaxi provides round-the-clock taxi service in Madurai for airport transfers, outstation trips, and local rides.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: 'Does TamilDropTaxi provide airport transfers in Chennai?',
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: 'Does TamilDropTaxi operate from Trichy airport?',
  ...
  },
  {
    ...
    longDescription:
      'Salem is a major city in Tamil Nadu known for its steel industry and Yercaud hills nearby. TamilDropTaxi offers reliable cab service from Salem to all destinations.',
...
export const GLOBAL_FAQS = [
  ...
  {
    q: 'How do I book a taxi online with TamilDropTaxi?',
  ...
  {
    q: 'Are TamilDropTaxi drivers verified?',
