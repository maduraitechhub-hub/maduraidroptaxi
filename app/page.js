...
const breadcrumbSchema  = buildBreadcrumbSchema([
  { name: 'Home',                              url: 'https://www.tamilnadudroptaxi.com/' },
  { name: 'Madurai Local & Round Trip Taxi',   url: 'https://www.tamilnadudroptaxi.com/madurai-local-round-trip-taxi' },
]);
const localServiceSchema = buildServiceSchema({
  ...
  areaServed:  'Madurai',
  phone:       '+91-9751500800',
  url:         'https://www.tamilnadudroptaxi.com/madurai-local-round-trip-taxi',
});
    ...
    <>
      ...
      <main>
        ...
        <section className="section-why section-pad">
          <div className="container">
            <div className="section-header-center">
              <h2 className="section-title">Why Choose TamilNadu Drop Taxi in Madurai?</h2>
            </div>
